...
def init_db(app):
    ...
    with app.app_context():
        ...
        if Funcionario.query.count() == 0:
            funcionario1 = Funcionario(nome="Giovanna", cargo="Gerente",email="giovanna@empresa.com",cpf="12345678901",salario="5000.00")
            funcionario2 = Funcionario(nome="Gaby", cargo="Gerente",email="gaby@empresa.com",cpf="98765432100",salario="8500.00")
            funcionario3 = Funcionario(nome="Rafael", cargo="Gerente",email="rafael@empresa.com",cpf="11223344556",salario="3500.00")
